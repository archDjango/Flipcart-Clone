...
const ProtectedRoute = ({ children, roles }) => {
  ...
  if (!role || (roles && !roles.includes(role))) {
    return <Navigate to={roles.includes('admin') ? '/admin-login' : '/login'} />;
  }
  return children;
};
                ...
                <div className="app-container">
                  ...
                  <main className="main-content">
                    <Routes>
                      ...
                      <Route path="/admin/manage-products" element={<ProtectedRoute roles={['admin']}><ManageProducts /></ProtectedRoute>} />
                    </Routes>
                  </main>
                </div>
              </Router>
